...
async function main() {
  ...
  //   if ([2,5,6].includes(tokenId)) continue;
    console.log(`Auctioning token ${tokenId.toString()} for a fixed price...`);
  ...
  // for (let tokenId = 0; tokenId < 12; tokenId++) {
  //   if (tokenId in [2,5,6]) continue;
